...
class BaseModelOutputWithPast(ModelOutput):
    ...
    hidden_states: Optional[tuple[torch.FloatTensor, ...]] = None
    attentions: Optional[tuple[torch.FloatTensor, ...]] = None
    fair_e_result_all: Optional[list] = None  # For MoE models, to store fair expert outputs
    hidden_class_out_all: Optional[list] = None  # For MoE models, to store classifier outputs
    route_save_all: Optional[list] = None  # For MoE models, to store router outputs
...
class CausalLMOutputWithPast(ModelOutput):
    ...
    hidden_states: Optional[tuple[torch.FloatTensor, ...]] = None
    attentions: Optional[tuple[torch.FloatTensor, ...]] = None
    class_loss: Optional[float] = None
    route_save_all: Optional[list] = None
