...
class DPOTrainer(Trainer):
    ...
    def concatenated_forward(
        ...
        if self.is_encoder_decoder:
            ...
            model_kwargs['age_label'] = batch['age_label']
            model_kwargs['gender_label'] = batch['gender_label']
            model_kwargs['alpha'] = batch['alpha']
        ...
        if self.aux_loss_enabled:
            output["aux_loss"] = outputs.aux_loss
        output['class_loss'] = outputs.class_loss
        return output
    ...
    def get_batch_loss_metrics(
        ...
        losses = losses.mean() + self.args.fairness_coef * model_output['class_loss']
